...
public:
	...
	friend void swapÑoefficient(Polynom& n); // ìåíÿåò êîıôôèöèåíòû â ìàññèâå çàäîì íàïåğåä!
...
int main() {
	...
	swapÑoefficient(number1);
	swapÑoefficient(number2);
...
void swapÑoefficient(Polynom& n)
{
